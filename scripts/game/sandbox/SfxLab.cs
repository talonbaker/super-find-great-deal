...
public enum Sfx
{
    ...
    // 24-42 reserved: DOOR-1, SFX-1, CLOCK-1.
    ...
    ///
    /// <para>Appended at <b>43</b>, leaving 24-42 unused, because three other lanes of this
    /// program are appending to this enum in parallel off the same base and cannot see each
    /// other — the ordinals above are pinned (see the note at the top of this enum) and a
    /// textual merge that renumbered one would silently re-point every presentation
    /// <c>.tres</c> that names it.</para></summary>
    Buzzer = 43,
}
