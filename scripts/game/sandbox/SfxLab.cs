...
public enum Sfx
{
    ...
    // generic clink. The ordinals start at 25 because DOOR-1 is landing Bang = 24 on a sibling
    // branch off the same base; leaving the gap makes that merge a no-op instead of a
    // renumbering, and a renumbering here would silently repoint every .tres in
