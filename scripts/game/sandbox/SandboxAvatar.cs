...
public partial class SandboxAvatar : CharacterBody3D, IServerConfirmedBody
{
    ...
    private void ConfigureNetworkedInstance()
    {
        ...
        else
        {
            ...
            //
            // INT-0 (2026-09-19): CARRY-1 branched off BASE-1 in parallel and still built the
            // third-person rig here. Its half of this block that SURVIVES is the rotator below;
            // the SandboxCamera + LocalInputIntentSource half is exactly what FP-1 deleted, and
            // restoring it would build a second camera, make it current, and put the player back
            // outside their own head. Taking both lanes literally here is the one place in this
            // merge where doing so would have been wrong.
            ...
            //
            // It reads the mouse in _Input and calls SetInputAsHandled while it is active;
            // FirstPersonCamera reads it in _UnhandledInput, which runs after. That is the
