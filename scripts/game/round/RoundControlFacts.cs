...
public sealed class RoundControlFacts : IRoundFactSource
{
    ...
    /// <inheritdoc/>
    /// <remarks>TASK-1's. Renamed from <c>TowersCompleted</c> at INT-1 (2026-09-19): BTN-1 wrote
    /// this against the interface as it stood on REACH-1's tip, and TASK-1 renamed the member on
    /// a sibling branch. Zero either way -- this lane answers nothing that belongs to the task
    /// room -- so the rename is the whole change.</remarks>
